...
*Mann-Whitney U Test-Test whether two statistically independent groups have been drawn from the same population with respect to the mean.
ranksum offer, by(study)

 
 /*Kolmogorov-Smirnov Test Test whether two statistically independent groups have been drawn
from the same population with respect to the distribution (mean,
skewness, kurtosis) */

ksmirnov offer, by(study)


*Wilcoxon Test- Test whether there are difference between two statistically dependent observations (X1 and X2).
signrank offer1 = offer2


*Binomial Test Test whether there the sampling distribution of a dichotomous random variable is different from a population with p = p0
bitest deviation==0.5

*χ2 Test
tab study offerdummy, chi
tab study offerdummy, exact

*Kruskal-Wallis Test
kwallis offer, by(age)
